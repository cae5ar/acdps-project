...
public class UserDao extends JpaDao<User> {
    ...
    public Long save(UserDto userDto, String password) throws AnyServiceException {
        User user = null;
        ...
        if (password != null) {
            user.getCredentials().setPassword(passwordEncoder.encodePassword(password, null));
        }
